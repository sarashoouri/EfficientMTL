...
args.output_dir='/nfs/turbo/coe-hunseok/sshoouri/pascal_finetune/sal/step2_sara_m_two'
...
saved=torch.load('/nfs/turbo/coe-hunseok/sshoouri/pascal_finetune/sal/step1_sara_m_one/checkpoint-last-info.pt',map_location=model.device)
nonzero_mask = {}
