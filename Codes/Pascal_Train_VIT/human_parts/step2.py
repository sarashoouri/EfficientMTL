...
args.output_dir='./pascal_finetune/human_parts/step2'
args.eval_freq=4
...
saved=torch.load('./pascal_finetune/human_parts/step1/checkpoint-last-info.pt',map_location=model.device)
nonzero_mask = {}
...
#args.warmup_steps=args.warmup_epoch*len(data_loader_train)
...
for epoch in range(args.start_epoch, args.epochs):
    ...
    if epoch % args.eval_freq == 0:
            ...
            if val_stats['mIoU'] > min_val_loss:
