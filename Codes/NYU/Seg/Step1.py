...
#DOMAIN_CONF['rgb_one_after']=DOMAIN_CONF['rgb']
#DOMAIN_CONF['rgb_one_before']=DOMAIN_CONF['rgb']
    # Dataset stuff
...
if args.distributed:
        model = torch.nn.parallel.DistributedDataParallel(model, device_ids=[gpu], find_unused_parameters=args.find_unused_params)
